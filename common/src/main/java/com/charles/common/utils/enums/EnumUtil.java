...
public class EnumUtil {
    ...
    @SuppressWarnings("unchecked")
    public static <E extends Enum<? extends NameValueEnum<V>>, V> String getNameByValue(Class<E> enumClass, V value) {
        for (Enum<? extends NameValueEnum<V>> e : enumClass.getEnumConstants()) {
            if (((NameValueEnum<V>) e).getValue().equals(value)) {
                return ((NameValueEnum<V>) e).getName();
            }
        }
        return null;
    }
    ...
    @SuppressWarnings("unchecked")
    public static <E extends Enum<? extends NameValueEnum<V>>, V> V getValueByName(Class<E> enumClass, String name) {
        for (Enum<? extends NameValueEnum<V>> e : enumClass.getEnumConstants()) {
            if (((NameValueEnum<V>) e).getName().equals(name)) {
                return ((NameValueEnum<V>) e).getValue();
            }
        }
        return null;
    }

...
public class NettySocketEventHandler {
    ...
    //socket事件消息接收入口
    @OnEvent("test") //value值与前端自行商定
    public void onEvent(SocketIOClient client, AckRequest request, String data) throws Exception {
        System.out.println(data);
        client.sendEvent("test", "已成功接收数据"); //向前端发送接收数据成功标识
